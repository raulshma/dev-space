...
/**
 * Priority level for feature suggestions
 */
export type FeatureSuggestionPriority = 'low' | 'medium' | 'high' | 'critical'

/**
 * Category of feature suggestion
 */
...
/**
 * A feature suggestion generated by AI analysis
 */
export interface FeatureSuggestion {
  id: string
  /** Project ID this suggestion belongs to */
  projectId: string
  /** Title of the suggested feature */
  title: string
  ...
  /** Rationale for why this feature is suggested */
  rationale: string
  /** Current status */
  status: FeatureSuggestionStatus
  /** ID of the task created when approved (if converted) */
  taskId?: string
  /** When the suggestion was generated */
  createdAt: Date
  /** When the suggestion was last updated */
  updatedAt: Date
  /** When the suggestion was approved/rejected */
  resolvedAt?: Date
...
/**
 * Input for creating a feature suggestion
 */
export interface CreateFeatureSuggestionInput {
  projectId: string
  title: string
  description: string
  category: FeatureSuggestionCategory
...
/**
 * Input for updating a feature suggestion
 */
export interface UpdateFeatureSuggestionInput {
  title?: string
  description?: string
  category?: FeatureSuggestionCategory
  priority?: FeatureSuggestionPriority
...
/**
 * Filter options for querying feature suggestions
 */
...
/**
 * Batch of suggestions from a generation session
 */
...
/**
 * Parameters for generating feature suggestions
 */
export interface GenerateSuggestionsParams {
  projectId: string
  projectPath: string
  /** Optional focus areas to analyze */
  focusAreas?: string[]
  ...
  /** Custom context to provide to the AI */
  customContext?: string
}

/**
 * Result from generating feature suggestions
 */
